...
<div class="bg-purple-100 min-h-screen pb-10">
  ...
  <div class="recipe-detail">
    <h1 class="font-cursive text-4xl font-bold text-center text-purple-800 mt-8 mb-6">Bolo de Chocolate</h1>
    <div class="recipe-image">
      <img src="/img/bolo-chocolate.jpg" alt="Bolo de Chocolate" />
    </div>
    <div class="recipe-info">
      <p><strong>Tempo de Preparo:</strong> 60 minutos</p>
    ...
    <div class="recipe-content">
      ...
      <div class="instructions">
        ...
        <ol>
          <li>Bata os ovos com o açúcar e o óleo.</li>
          <li>Acrescente o chocolate em pó e a farinha, alternando com a água quente.</li>
          <li>Por último, adicione o fermento.</li>
          <li>Asse em forno pré-aquecido a 180°C por cerca de 40 minutos.</li>
        </ol>
      </div>
    </div>
  </div>
